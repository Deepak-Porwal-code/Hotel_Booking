...
<img src={assets.linkendinIcon} alt="Linkedin icon" className="w-6 " />
        ...
        <div>
          <p className=" font-playfairtext-lg text-gray-800">SUPPORT</p>
          <ul className="mt-3 flex flex-col gap-2 text-sm">
            <li>
        ...
        <div className="max-w-80">
          <p className=" font-playfairtext-lg text-gray-800">STAY UPDATED</p>
...
<img src={assets.arrowIcon} alt="arrow icon" className="w-3.5 invert" />
      ...
      <div className="flex flex-col md:flex-row gap-2 items-center justify-between py-5">
        <p>© {new Date().getFullYear()} Booking. All rights reserved.</p>
